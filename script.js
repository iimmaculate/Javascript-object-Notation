const jsonUrl = 'https://raw.githubusercontent.com/iimmaculate/Javascript-object-Notation/refs/heads/main/admission.json';
...
fetch(jsonUrl)
    ...
    function visualizeDataDistrict(data) {
        ...
        const districtCounts = allStudents.reduce((counts, student) => {
            counts[student.dname] = (counts[student.dname] || 0) + 1;
            return counts;
        }, {});
    ...
    function visualizeDatatrends(data) {
        ...
        const trendCounts = allStudents.reduce((counts, student) => {
            counts[student.uace_yr] = (counts[student.uace_yr] || 0) + 1;
            return counts;
        }, {});
    ...
    function visualizeDatapopularity(data) {
        ...
        const popularityCounts = allStudents.reduce((counts, student) => {
            counts[student.course_name] = (counts[student.course_name] || 0) + 1;
            return counts;
        }, {});
